...
def main() -> None:
    ...
    display(close.head(1))
    print(close.shape,df.shape)
    ...
    print('close.shape,close_.shape',close.shape,close_.shape) 
    ...
    print(f"cusum h={h:.8f} tEvents={len(tEvents)}")
    print(f"vertical barriers t1={len(t1)}")
